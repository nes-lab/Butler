 ...
 * Marco Zimmerling, 2013; Carsten Herrmann 2018
 */
...
//#define UART1_PUTCHAR_CONF_BUF_SIZE		255
#define INTER_FRAME_SPACE				1000

int uart1_writeb(unsigned char c);

#if TINYOS_SERIAL_FRAMES

#if INTER_FRAME_SPACE
...
#if INTER_FRAME_SPACE
	static Gpi_Slow_Tick_Extended		last_out_tick = 0;
#endif
...
#if INTER_FRAME_SPACE
	while (gpi_tick_slow_extended() - last_out_tick < GPI_TICK_MS_TO_SLOW(1000));
#endif
...
#if INTER_FRAME_SPACE
	last_out_tick = gpi_tick_slow_extended();
#endif
